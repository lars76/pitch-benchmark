...
def silence_keep(mic16k: np.ndarray, nfr: int, thr: float = 0.05) -> np.ndarray:
    ...
    the author path is. Committed npz files must be regenerated by THIS script so they carry
    these exact conventions (centered gate, calibrated estimator timestamps)."""
